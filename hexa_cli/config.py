...
CONFIG_DIR = Path.home() / ".hexallm"
CONFIG_FILE = CONFIG_DIR / "config.json"

_FIELDS = {
    "model", "ollama_url", "hexallm_url", "hexallm_token",
...
@dataclass
class Config:
    # "auto" = HexaLLM > Ollama > Pollinations (recommended)
    ...
    hexallm_url: Optional[str] = None
    hexallm_token: Optional[str] = None
    max_steps: int = 20
