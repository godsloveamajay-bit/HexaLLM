...
def _seed_plans(db: Session):
    ...
    plans = [
        ...
        Plan(
            ...
            limits={"chat_daily": -1, "agent_daily": -1, "kb_max": -1, "image_gen": True, "priority": True},
            sort_order=1,
        ),
        Plan(
            name="Supreme",
            ...
            limits={"chat_daily": -1, "agent_daily": -1, "kb_max": -1, "image_gen": True, "priority": True, "api_rate_boost": 10},
            sort_order=2,
        ),
    ]
    for p in plans:
